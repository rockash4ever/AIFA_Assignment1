...
class Environment(object):
    ...
    def make_agent_dict(self):
        for agent in self.agents:
            ...
            start_state = State(self.agents_time[agent['name']], Location(agent['start'][0], agent['start'][1]))
            goal_state = State(self.agents_time[agent['name']], Location(agent['goal'][0], agent['goal'][1]))
...
def main():
    ...
    while len(agents)>0:
        ...
        if k == 1:
            ...
            with open(args.output, 'a') as output_yaml:
                yaml.safe_dump(revised_output, output_yaml)
